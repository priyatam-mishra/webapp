...
document.querySelectorAll('.contact')[0].addEventListener('click', () => {
   let x = document.querySelector('.sec_menu').style
   x.transform = 'translateX(-300px)'
   x.transition = 'all .8s'
})

document.querySelectorAll('.home')[0].addEventListener('click', () => {
   let x = document.querySelector('.sec_menu').style
   x.transform = 'translateX(-300px)'
   x.transition = 'all .8s'
})

document.querySelectorAll('.membership')[0].addEventListener('click', () => {
   let x = document.querySelector('.sec_menu').style
   x.transform = 'translateX(-300px)'
   x.transition = 'all .8s'
})
